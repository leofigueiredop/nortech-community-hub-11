...
export interface Event {
  ...
  speaker?: string;
  url?: string;
  status?: 'upcoming' | 'live' | 'ended' | 'happening_soon' | 'in_progress' | 'ongoing' | 'past' | 'canceled';
  pointsValue?: number;
  platform?: string;
...
export const EVENT_TYPES: Record<string, { label: string; icon: ReactNode; color: string; }> = {
  workshop: { 
    label: 'Workshop', 
    icon: <span>🛠️</span>, 
